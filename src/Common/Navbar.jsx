            ...
            <div className="container-fluid p-0 nav-bar ">
                <nav className="navbar navbar-expand-lg bg-none navbar-dark py-3 ">
                    <Link to="/" className="navbar-brand">
                        <h1 className="m-0 display-4 font-weight-bold text-uppercase text-white">SD's GYM</h1>
                    </Link>
                    ...
                    <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div className="navbar-nav ml-auto p-4 bg-secondary">
                            ...
                            {LogoutToggle ? (
                                ...
                                <NavLink className="dropdown-item" to={`/dashboard/${localStorage.getItem('_id')}`}>{name}</NavLink>
                                <NavLink className="dropdown-item" style={{ textDecoration: "none" }} onClick={logOut}>Logout <i className="fas fa-sign-out-alt"></i></NavLink>
                                </div>
                            </div>
